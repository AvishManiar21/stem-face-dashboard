...
class TutorAnalytics:
    ...
    """
    def __init__(self, face_log_file='data/legacy/face_log_with_expected.csv', max_date=None, custom_data=None):
    ...
    def assign_shift_to_tutor(self, shift_id, tutor_id):
        ...
        try:
            ...
            try:
                face_df = pd.read_csv('data/legacy/face_log.csv')
